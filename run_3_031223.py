...
drive_base.turn(90)
drive_base.straight(145) # changing
front_motor.run_angle(200,-215)

#slow speed to move backwards and slow turn
drive_base.settings(straight_speed=100,straight_acceleration=600)
drive_base.settings(turn_rate=80,turn_acceleration=450)
drive_base.straight(-50) # move back from the camera bit
drive_base.turn(71)
...
drive_base.turn(-25)
back_motor.run_angle(600,-250) # Negative value of angle means move arm DOWN
back_motor.run_angle(600,270) # Negative value of angle means move arm DOWN
